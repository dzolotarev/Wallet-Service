...
@WebServlet("/balance")
public class UserShowBalanceServlet extends HttpServlet {
        ...
        if (jwt == null) {
            ...
            try {
                ...
                if (id < 0) {
                    ...
                    resp.getOutputStream().write(ObjectMap.get().writeValueAsBytes(AccountRepositoryDBImpl.getInstance().findUserAccount(id).getBalance()));
                }
