...
@WebServlet("/credit")
public class UserCreditServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String jwt = jsonNode.get("token").asText(null);
        if (jwt == null) {
            ...
            try {
                ...
                if (id < 0 || value == 0) {
                    ...
                    boolean result = TransactionManager.getInstance().credit(value, id);
                    resp.setStatus(HttpServletResponse.SC_OK);
                    resp.getOutputStream().write(ObjectMap.get().writeValueAsBytes(result));
                }
